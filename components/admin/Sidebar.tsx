...
import { LayoutDashboard, ShoppingBag, Package, Users, Settings, LogOut, Store, Palette, Folder, Image as ImageIcon, MessageSquare } from 'lucide-react';
...
const MENU_ITEMS = [
    ...
    { name: 'Content', href: '/admin/content', icon: Folder },
