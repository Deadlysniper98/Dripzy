...
"[project]/app/api/cj/auth/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cj$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cjClient"].getCategories();
...
async function POST(request) {
    try {
        ...
        if (action === 'getToken' && apiKey) {
            ...
            const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cj$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cjClient"].getAccessToken();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        if (action === 'refresh' && refreshToken) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cj$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cjClient"].setTokens('', refreshToken);
            const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cj$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cjClient"].refreshAccessToken();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Invalid action. Use "getToken" with apiKey or "refresh" with refreshToken'
        }, {
            status: 400
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__659c4ec3._.js.map